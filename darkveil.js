/**
 * LXWYER UP — DARKVEIL WEBGL BACKGROUND
 * Faithful vanilla-JS port of the DarkVeil component (ogl based)
 */
...
`;
  ...
  const loop = () => {
    ...
    // allow dynamic updates if needed
    program.uniforms.uHueShift.value = config.hueShift;
    program.uniforms.uNoise.value = config.noiseIntensity;
    program.uniforms.uScan.value = config.scanlineIntensity;
    program.uniforms.uScanFreq.value = config.scanlineFrequency;
    program.uniforms.uWarp.value = config.warpAmount;
